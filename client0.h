...
namespace _ghx
{
    ...
    public:
        ...
        long            SendQueue() const    { return conn_obj_->SendQueue(); }
        char*           CurrAddr() const     { return conn_obj_->CurrAddr(); }
        long            CurrPort() const     { return conn_obj_->CurrPort(); }
        char*           PeerAddr() const     { return conn_obj_->PeerAddr(); }
        long            PeerPort() const     { return conn_obj_->PeerPort(); }
        long            KeepTimeout() const  { return conn_obj_->KeepTimeout(); }
        long            KeepInterval() const { return conn_obj_->KeepInterval(); }
        long            KeepRetryTimes()const{ return conn_obj_->KeepRetryTimes(); }
