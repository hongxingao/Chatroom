...
namespace _ghx
{
    ...
    public:
        ...
        long            SendQueue() const                        { return obj_server_->SendQueue(); }
        long            ListenQueue() const                      { return obj_server_->ListenQueue(); }
        long            RecvThreads() const                      { return obj_server_->RecvThreads(); }
        long            CacheThreads() const                     { return obj_server_->CacheThreads(); }
        long            MaxClients() const                       { return obj_server_->MaxClients(); }
        long            ClientCount() const                      { return obj_server_->ClientCount(); }
        long            KeepTimeout() const                      { return obj_server_->KeepTimeout(); }
        long            KeepInterval() const                     { return obj_server_->KeepInterval(); }
        long            KeepRetryTimes() const                   { return obj_server_->KeepRetryTimes(); }
